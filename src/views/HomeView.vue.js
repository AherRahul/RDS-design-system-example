...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.strong, __VLS_intrinsicElements.strong)({});
    const __VLS_0 = {}.RdsDivider;
    ({}.RdsDivider);
    __VLS_components.RdsDivider;
    __VLS_components.rdsDivider;
    // @ts-ignore
    [RdsDivider,];
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ width: ((0)), }));
    const __VLS_2 = __VLS_1({ width: ((0)), }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    ({}({ width: ((0)), }));
    const __VLS_5 = __VLS_pickFunctionalComponentCtx(__VLS_0, __VLS_2);
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("row mt-4") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("col") }, });
    const __VLS_6 = {}.RdsGrid;
    ({}.RdsGrid);
    ({}.RdsGrid);
    ...
    if (typeof __VLS_styleScopedClasses === 'object' && !Array.isArray(__VLS_styleScopedClasses)) {
        ...
        __VLS_styleScopedClasses['mt-4'];
        __VLS_styleScopedClasses['col'];
        __VLS_styleScopedClasses['heading-3'];
